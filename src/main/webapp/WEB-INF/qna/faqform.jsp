            ...
            <form action="faqinsert" method="post">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <th>공지내용</th>
                        <td>
                            <textarea name="content" id="faqcontent" class="form-control" required="required"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" align="center">
                            <button type="submit" class="btn btn-secondary addqna">게시글 저장</button>
                            <button type="button" class="btn btn-secondary prevqna" onclick="location.href='faqlist?currnetPage=${currentPage}'">이전</button>
                        </td>
                    </tr>
                </table>
            </form>
