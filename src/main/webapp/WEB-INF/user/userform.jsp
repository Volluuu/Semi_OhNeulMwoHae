    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#pass").keyup(function () {
                ...
                if (!regex.test(p1)) {
                    $("#passwordSuccess").text("조건에 맞게 입력해주세요 [대소문자 사용] [8자 이상 20자 이하]");
