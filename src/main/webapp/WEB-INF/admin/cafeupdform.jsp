                    ...
                    <div style="width: 1100px;margin: 0 auto;">
                        <div style="background-color: white; width: 80%; margin: 0 auto;padding: 5%;box-shadow: 5px 5px 10px gray">
                            ...
                            <form action="cafeupdact" method="post" enctype="multipart/form-data">
                                ...
                                <div>이름<input type="text" name="title" class="form-control rounded-pill" required="required" value="${dto.title}"></div>
                                <div>주소<input type="text" name="addr" class="form-control rounded-pill" required="required" value="${dto.addr}"></div>
                                <div>대표메뉴<input type="text" name="menu" class="form-control rounded-pill" required="required" value="${dto.menu}"></div>
                                <div>전화번호<input type="text" name="tel" class="form-control rounded-pill" required="required" value="${dto.tel}"></div>
                                <div>위도<input type="text" name="lat" class="form-control rounded-pill" required="required" value="${dto.lat}"></div>
                                <div>경도<input type="text" name="lon" class="form-control rounded-pill" required="required" value="${dto.lon}"></div>
                                <div>구
                                ...
                                <div style="text-align: center">
                                    <button type="submit"  class="button" data-hover="CLICK ME!!" data-active="I'M ACTIVE"><span>카페수정</span></button>
