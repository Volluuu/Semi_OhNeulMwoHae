...
<body>
  ...
  <form action="foodinsertact" method="post" enctype="multipart/form-data">
      ...
      <div>카테고리<input type="text" name="category" class="form-control" required="required"></div>
      ...
      <div>위도<input type="text" name="lat" class="form-control" required="required" placeholder="37.348162598"></div>
      <div>경도<input type="text" name="lon" class="form-control" required="required" placeholder="127.138418235"></div>
      ...
      <button type="submit" class="btn btn-outline-secondary">푸드코스 추가</button>
  </form>
</body>
</html>
