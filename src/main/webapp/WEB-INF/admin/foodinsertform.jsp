                ...
                <div class="row">
                    <div style="width: 1100px;margin: 0 auto;">
                        <div style="background-color: white; width: 80%; margin: 0 auto;padding: 5%;box-shadow: 5px 5px 10px gray">
                            <h1 style="color: #44A3F7">Food Insert</h1>
                            <form action="foodinsertact" method="post" enctype="multipart/form-data">
                                ...
                                <div>카테고리<input type="text" name="category" class="form-control rounded-pill" required="required"></div>
                                <div>대표메뉴<input type="text" name="menu" class="form-control rounded-pill" required="required"></div>
                                <div>전화번호<input type="text" name="tel" class="form-control rounded-pill" required="required"></div>
                                <div>위도<input type="text" name="lat" class="form-control rounded-pill" required="required" placeholder="37.348162598"></div>
                                <div>경도<input type="text" name="lon" class="form-control rounded-pill" required="required" placeholder="127.138418235"></div>
                                <div>구
                                ...
                                <div style="text-align: center">
                                    <button type="submit" class="button" data-hover="CLICK ME!!" data-active="I'M ACTIVE"><span>푸드추가</span></button>
                                    <button type="button" class="button" data-hover="BACK!!" data-active="I'M ACTIVE" onclick="location.href='${root}/admin/foodcourse'"><span>목록으로</span></button>
                                </div>
                            </form>
                        </div>
                    </div>
