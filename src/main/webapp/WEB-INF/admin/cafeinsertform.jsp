    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div style="width: 1100px;margin: 0 auto;">
                     <div style="background-color: white; width: 80%; margin: 0 auto;padding: 5%;box-shadow: 5px 5px 10px gray">
                         <h1 style="color: #44A3F7">Cafe Insert</h1>
                       <form action="cafeinsertact" method="post" enctype="multipart/form-data">
                           ...
                           <div>위도<input type="text" name="lat" class="form-control rounded-pill" required="required" placeholder="37.129323915"></div>
                           <div>경도<input type="text" name="lon" class="form-control rounded-pill" required="required" placeholder="127.328429384"></div>
                           <div>구
                           ...
                           <div style="text-align: center">
                               <button type="submit" class="button" data-hover="CLICK ME!!" data-active="I'M ACTIVE"><span>카페추가</span></button>
