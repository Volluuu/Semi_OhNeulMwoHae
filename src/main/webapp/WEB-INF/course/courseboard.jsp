...
<svg version="1.1" id="레이어_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
     y="0px" width="50%" height="auto" viewBox="100 100 2551.2 1236" xml:space="preserve">
...
<script>
    $.getJSON("https://api.openweathermap.org/data/2.5/weather?q=seoul&appid=36ccda560636ea50a6c38074156e4bef&units=metric", function (result) {
    ...
    $(document).on("click", ".gu1,.gu2,.gu3,.gu4,.gu5,.gu6,.gu7,.gu8,.gu9,.gu10,.gu11,.gu12,.gu13,.gu14,.gu15,.gu16,.gu17,.gu18,.gu19,.gu20,.gu21,.gu22,.gu23,.gu24,.gu25", function () {
        ...
        $.ajax({
            ...
            success: function (result) {
                var ta = "";
                $.each(result, function (elt) {
                    // var ctime = elt.dt//배열 시간
                    var ctemp = main.temp//배열 날씨
                    var cgangsu = main.humidity//강수 확률
                    var cwind = wind.speed//풍속
                    var wicon = "<img src='http://openweathermap.org/img/wn/" + elt.weather.icon + ".png' alt='" + elt.weather.discription + "'>"
