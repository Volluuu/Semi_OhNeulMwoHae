...
<script>
    // $(document).on("mouseenter",".st39",function(){
    //     $(this).attr("filter","url(#solid)");
    // });
    // $(document).on("mouseleave",".st39",function(){
    //     $(this).attr("filter","");
    // });
...
<%--             <feFlood flood-color="mediumpurple" result="bg" />--%>
<%--             <feMerge>--%>
<%--                 <feMergeNode in="bg"/>--%>
...
<%--         </filter>--%>
<%--     </defs>--%>
<%--    <text filter="url(#solid)" x="20" y="50" font-size="50" class="gu1">solid background</text>--%>
<style type="text/css">
    /*.st1:hover, .st2:hover, .st3:hover, .st4:hover, .st5:hover, .st6:hover, .st7:hover, .st8:hover, .st9:hover, .st10:hover,*/
    /*.st11:hover, .st12:hover, .st13:hover, .st14:hover, .st18:hover, .st22:hover, .st23:hover, .st24:hover, .st25:hover, .st26:hover, .st27:hover, .st30:hover,*/
    /*.st31:hover, .st32:hover, .st34:hover, .st35:hover, .st36:hover, .st37:hover, .st38:hover, .st42:hover {*/
    /*    fill: mediumpurple;*/
    /*    opacity: 0.8;*/
    /*    stroke: red;*/
    /*}*/
    /*path.hanriver:hover, path.gu1:hover, path.gu2:hover, path.gu3:hover, path.gu4:hover, path.gu5:hover, path.gu6:hover, path.gu7:hover, path.gu8:hover, path.gu9:hover, path.gu10:hover, path.gu11:hover, path.gu12:hover, path.gu13:hover, path.gu14:hover, path.gu15:hover, path.gu16:hover, path.gu17:hover, path.gu18:hover, path.gu19:hover, path.gu20:hover, path.gu21:hover, path.gu22:hover, path.gu23:hover, path.gu24:hover, path.gu25:hover{*/
    /*    fill: mediumpurple;*/
    /*    opacity: 0.8;*/
    /*    cursor: pointer;*/
    /*    z-index: 1;*/
...
<script>
    ...
    $(document).on("click",".gu1,.gu2,.gu3,.gu4,.gu5,.gu6,.gu7,.gu8,.gu9,.gu10,.gu11,.gu12,.gu13,.gu14,.gu15,.gu16,.gu17,.gu18,.gu19,.gu20,.gu21,.gu22,.gu23,.gu24,.gu25",function(){
        ...
        switch (gu){
            case "1": guname="강남구";break;
            case "2": guname="강동구";break;
            case "3": guname="강북구";break;
            case "4": guname="강서구";break;
            case "5": guname="관악구";break;
            case "6": guname="광진구";break;
            case "7": guname="구로구";break;
            case "8": guname="금천구";break;
            case "9": guname="노원구";break;
            case "10": guname="도봉구";break;
            case "11": guname="동대문구";break;
            case "12": guname="동작구";break;
            case "13": guname="마포구";break;
            case "14": guname="서대문구";break;
            case "15": guname="서초구";break;
            case "16": guname="성동구";break;
            case "17": guname="성북구";break;
            case "18": guname="송파구";break;
            case "19": guname="양천구";break;
            case "20": guname="영등포구";break;
            case "21": guname="용산구";break;
            case "22": guname="은평구";break;
