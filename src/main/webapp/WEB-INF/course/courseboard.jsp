...
<div class="map_weather">
	...
	C1290.4,638.6,1291.7,637.9,1291.6,635.1z"/>
            ...
            <text transform="matrix(1 0 0 1 1447.6338 968.3757)" class="st39 st40 gu1" lon="127.0495" lat="37.5145"
                  gu="1">
                강남구
            </text>
            <text transform="matrix(1 0 0 1 1289.5262 1007.8318)" class="st39 st40 gu15" lon="127.0348"
                  lat="37.4807"
                  gu="15">서초구
            </text>
            <text transform="matrix(1 0 0 1 1093.476 1067.2949)" class="st39 st40 gu5" lon="126.9538" lat="37.4753"
                  gu="5">
                관악구
            </text>
            ...
            <text transform="matrix(1 0 0 1 951.5786 844.35)" class="st39 st40 gu20" lon="126.8983" lat="37.5236"
                  gu="20">
                영등포구
            </text>
            <text transform="matrix(1 0 0 1 936.382 1033.7063)" class="st39 st40 gu8" lon="127.0495" lat="37.4491"
                  gu="8">
                금천구
            </text>
            <%--    구로구7--%>
		...
		c3.8,0.1,7.6,0.9,11.4,0.7C809.7,884.6,812.5,883.3,815.6,882.3z"/>
                <text transform="matrix(1 0 0 1 796.632 934.4565)" class="st39 st40 gu7" lon="126.9041"
                      lat="37.4926"
                      gu="7">구로구
                </text>
            </g>
            <text transform="matrix(1 0 0 1 816.2925 827.8484)" class="st39 st40 gu19" lon="126.8687" lat="37.5142"
                  gu="19">
                양천구
            </text>
            <text transform="matrix(1 0 0 1 719.1567 660.7769)" class="st39 st40 gu4" lon="126.8516" lat="37.5481"
                  gu="4">
                강서구
            </text>
            <text transform="matrix(1 0 0 1 973.5876 672.8569)" class="st39 st40 gu13" lon="126.9105" lat="37.5607"
                  gu="13">
                마포구
            </text>
            ...
            <text transform="matrix(1 0 0 1 1051.9479 429.657)" class="st39 st40 gu22" lon="126.9312" lat="37.5999"
                  gu="22">
                은평구
            </text>
            ...
            <text transform="matrix(1 0 0 1 1232.739 679.2552)" class="st39 st40 gu24" lon="126.9996" lat="37.5610"
                  gu="24">
                중구
            </text>
            ...
            <text transform="matrix(1 0 0 1 1397.6136 598.001)" class="st39 st40 gu11" lon="127.0421" lat="37.5716"
                  gu="11">
                동대문구
            </text>
            ...
            <text transform="matrix(1 0 0 1 1310.2233 373.7785)" class="st39 st40 gu3" lon="127.0277" lat="37.6369"
                  gu="3">
                강북구
            </text>
            ...
            <text transform="matrix(1 0 0 1 1492.5422 313.7598)" class="st39 st40 gu9" lon="127.0583" lat="37.6514"
                  gu="9">
                노원구
            </text>
            ...
            <text transform="matrix(1 0 0 1 1514.0481 725.0132)" class="st39 st40 gu6" lon="127.0651" lat="37.5340"
                  gu="6">
                광진구
            </text>
            <%--    송파구18--%>
		...
		c-2.8,14.7-6.9,18.6-20.3,18.9c-12.2,0.3-17,4.2-20.8,15.8c-3.3,10-8,17.1-20.6,16.2c-3.8-0.3-6.1,1.5-7.9,3.9"/>
			...
			c-10.8-4-20.6-11-30.7-16.9s-15.6-15.6-19.9-25.8c-1.6-3.8-1.8-8.4-1.9-12.7C1491.5,863.2,1491.6,849.5,1491.6,835.4z"/>
                <text transform="matrix(1 0 0 1 1606.7791 918.2496)" class="st39 st40 gu18" lon="127.1079"
                      lat="37.5117"
                      gu="18">송파구
                </text>
		...
		c1.2,15-5.1,27.7-12.8,40c-6.9,11-13.7,22.1-20.5,33.2L1719.9,856.6z"/>
			...
			c-21.1,6.9-42.2,13.6-63.3,20.4c-5.9,1.9-8.4,4.7-8,10.9c1,15.5-4.5,28.7-13.4,41.1C1732.7,834.9,1728.2,843.5,1722.9,851.9z"/>
                <text transform="matrix(1 0 0 1 1688.0695 732.9474)" class="st39 st40 gu2" lon="127.1258"
                      lat="37.5273"
                      gu="2">강동구
                </text>
    ...
    <div class="jgfRlo" style="float: right;">
                ...
                success: function (suc) {
                    if (suc.totalCount == 0) {
                        ...
                        $.each(suc.list, function (i, res) {
                            ...
                            c += '<li class="comments"><i class="fa-solid fa-comments"></i>&nbsp;' + res.answercount + '</li>';
                            c += '<li class="view"><i class="fa-regular fa-eye"></i>&nbsp;' + res.readcount + '</li>';
                ...
                success: function (suc) {
                    if (suc.totalCount == 0) {
                        ...
                        $.each(suc.list, function (i, res) {
                            ...
                            f += '<li class="comments"><i class="fa-solid fa-comments"></i>&nbsp;' + res.answercount + '</li>';
                            f += '<li class="view"><i class="fa-regular fa-eye"></i>&nbsp;' + res.readcount + '</li>';
                ...
                success: function (suc) {
                    if (suc.totalCount == 0) {
                        ...
                        $.each(suc.list, function (i, res) {
                            ...
                            t += '<li class="comments"><i class="fa-solid fa-comments"></i>&nbsp;' + res.answercount + '</li>';
                            t += '<li class="view"><i class="fa-regular fa-eye"></i>&nbsp;' + res.readcount + '</li>';
...
<div class="container Cafe" style="width:100%; height: 100%;" id="divgrid">
                ...
                <div class="blog-card spring-fever">
                    ...
                    <div class="utility-info">
                        <ul class="utility-list">
                            <li class="comments"><i class="fa-solid fa-comments"></i>&nbsp;${dto.answercount}</li>
                            <li class="view"><i class="fa-regular fa-eye"></i>&nbsp;${dto.readcount}</li>
                            <li class="staravg"><i class="fa-solid fa-star"></i>&nbsp;${dto.staravg}</li>
                            <li class="substotal"><i class="fa-solid fa-heart"
                                                     style="color:red;"></i>&nbsp;${dto.substotal}</li>
                        </ul>
                    </div><!-- /.utility-info -->
                    <!-- overlays -->
...
<div class="paging" id="paging" style="justify-content: center">
    <ul class="pagination">
...
<script>
    ...
    $(document).on("click", ".gu1,.gu2,.gu3,.gu4,.gu5,.gu6,.gu7,.gu8,.gu9,.gu10,.gu11,.gu12,.gu13,.gu14,.gu15,.gu16,.gu17,.gu18,.gu19,.gu20,.gu21,.gu22,.gu23,.gu24,.gu25", function () {
        ...
        $.ajax({
            type: "get",
            url: "https://api.openweathermap.org/data/2.5/weather?lat=" + lat + "&lon=" + lon + "&appid=36ccda560636ea50a6c38074156e4bef&units=metric",
            dataType: "json",
            success: function (result) {
                var xtemp = result.main.temp_max
                var mtemp = result.main.temp_min//배열 날씨
