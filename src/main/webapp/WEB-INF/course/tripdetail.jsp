                ...
                <div class="hj_bhead">
                    <div class="hj_bbody">
                        ...
                        <div id="topinfo" type="companion" class="iYZztd">
                            ...
                            <div>
                                <p><i class="fa-solid fa-info" style="color: deepskyblue; margin-left: 5px;"></i> ${dto.content}</p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <c:if test="${sessionScope.loginok!=null}">
                                    <form class="mb-3" id="myform">
                                        ...
                                        <input type="hidden" name="cafe_num" value="${dto.trip_num}">
                                        <fieldset>
